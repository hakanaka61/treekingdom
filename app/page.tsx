...
// ==========================================
// 1. AYARLAR & OYUN DENGESİ (V26.1 COMPLETE)
// ==========================================
const CONFIG = {
...
export default function GamePage() {
  ...
  const saveGame = () => {
      ...
      const updates: any = {};
      updates[`empires_final/${gs.current.userId}`] = { player: gs.current.player, entities: gs.current.entities, fog: gs.current.fog };
  ...
  const updateLogic = () => {
      ...
      const remainingSeconds = isNight ? Math.floor((1 - cycle) * totalSeconds) : Math.floor((0.5 - cycle) * totalSeconds);
  ...
  // --- EKSİK OLAN HANDLEBUILD FONKSİYONU ---
