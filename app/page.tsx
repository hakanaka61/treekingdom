...
// ==========================================
// 1. AYARLAR & OYUN DENGESİ (V32.3 FIXED)
// ==========================================
const CONFIG = {
...
export default function GamePage() {
  ...
  const generateMap = () => {
      ...
      gs.current.camera.x = 0; gs.current.camera.y = (CONFIG.MAP_SIZE) * (CONFIG.TILE_HEIGHT/2);
      gs.current.camera.targetX = gs.current.camera.x; gs.current.camera.targetY = gs.current.camera.y;
  };
  ...
  const updateUi = () => {
      ...
      // FIX: Upgrades UI state güncelleme
