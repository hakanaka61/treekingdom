...
export default function GamePage() {
  ...
  // --- SAFARI & MOBİL UYUMLU INPUT HANDLER ---
  const handleInput = (e: any) => {
    // 1. Dokunma ve Mouse koordinatlarını tek bir yerde alalım
    ...
    if(e.type==='mousedown' || e.type==='touchstart') {
        ...
        if(e.type === 'touchmove' || e.buttons === 1) {
             ...
             if(gs.current.input.isDragging) {
                 gs.current.camera.targetX += (gs.current.input.lastX - cx) * 1.5; // Hassasiyet artırıldı
